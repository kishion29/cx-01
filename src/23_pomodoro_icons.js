...
function renderChatMorePanel(){
  ...
  if(!enabledItems||!Array.isArray(enabledItems)||enabledItems.length===0){
    enabledItems=['image','ask_ta','ask_invite_records','copy_msg','long_screenshot','fav_msg','my_favs','cards','topbar_cards','search_chat','date_search','touch','decision','group_decision','divine','invite','call','survey','piggy','letters','board','period','pomodoro','mood_cards_library','contact-profile','favorites','ta_highlights','chat_stats','star_music','star_cal','diary','ta_distance','ta_touch','ta_daily','read_together','read_cards','read_video','toggle_bottom_nav','ai_diviner','ta_ask','ai_card_memory','ai_card_records','ai_chat','meals'];
  }else{
    // ★ 铁证：无论 customChatbarEnabled 来自哪里（旧存档/未合并），渲染时都强制补全新功能
    ['ask_ta','ask_invite_records','ta_distance','ta_touch','ta_daily','read_together','read_cards','read_video','toggle_bottom_nav','ai_diviner','ta_ask','ai_card_memory','ai_card_records','ai_chat','meals','invite','piggy'].forEach(function(_i){
  ...
  if(cid){
    ...
    if(c&&c.chatbarOrder&&Array.isArray(c.chatbarOrder)){
      ...
      var _newIds=['ask_ta','ask_invite_records','ta_distance','ta_touch','ta_daily','ta_highlights','chat_stats','star_music','star_cal','mood_cards_library','read_together','read_cards','read_video','toggle_bottom_nav','ai_diviner','ta_ask','ai_card_memory','ai_card_records','ai_chat','meals','invite','piggy'];
